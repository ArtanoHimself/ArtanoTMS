...
class ViewController: UIViewController {
    ...
    @objc func didTap () {
        ...
        circle.backgroundColor = [UIColor.red, UIColor.green, UIColor.black,
                                  UIColor.yellow, UIColor.lightGray, UIColor.orange,
                                  UIColor.systemTeal, UIColor.systemIndigo].randomElement()
    }
    ...
    @objc func didPress (gesture: UILongPressGestureRecognizer) {
        ...
        case .changed:
            func prikol () {
                ...
                myView.backgroundColor = [UIColor.red, UIColor.green, UIColor.black,
                                          UIColor.yellow, UIColor.lightGray, UIColor.orange,
                                          UIColor.systemTeal, UIColor.systemIndigo].randomElement()
                myView.layer.cornerRadius = 25
